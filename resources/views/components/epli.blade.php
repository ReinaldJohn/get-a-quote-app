        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_fein" id="epli_fein" class="form-control required"
                        placeholder="FEIN No.:" />
            ...
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_current_epli" id="epli_current_epli" class="form-control required"
            ...
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_prior_carrier" id="epli_prior_carrier"
                        class="form-control required" placeholder="Prior Carrier:" />
            ...
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_prior_carrier_epli" id="epli_prior_carrier_epli"
                        class="form-control required" placeholder="Prior Carrier EPLI:" />
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_effective_date" id="epli_effective_date"
                        class="form-control required" placeholder="Effective Date:" />
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_prev_premium_amount" id="epli_prev_premium_amount"
                        class="form-control required" placeholder="Previous Premium Amount:" />
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_deductible_amount" id="epli_deductible_amount"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_no_of_losses" id="epli_no_of_losses"
...
<div class="step" id="epli_step_2">
    @if (session('doesEPLIChecked') === 'true')
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_full_time" id="epli_full_time" class="form-control required"
            ...
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_part_time" id="epli_part_time" class="form-control required"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_independent_contractors" id="epli_independent_contractors"
                        class="form-control required" placeholder="Independent Contractors:" />
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_volunteers" id="epli_volunteers" class="form-control required"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_leased_seasonal" id="epli_leased_seasonal"
                        class="form-control required" placeholder="Leased or Seasonal:" />
                    <label for="epli_leased_seasonal">Leased or Seasonal:</label>
                </div>
            </div>
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_non_us_base_emp" id="epli_non_us_base_emp"
                        class="form-control required" placeholder="Non-US base Emp.:" />
                    <label for="epli_non_us_base_emp">Non-US base Emp.:</label>
                </div>
            </div>
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_total_employees" id="epli_total_employees"
                        class="form-control required" placeholder="Total Employees:" />
...
<div class="step" id="epli_step_3">
    @if (session('doesEPLIChecked') === 'true')
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_located_at_ca" id="epli_located_at_ca"
                        class="form-control required" placeholder="CA:" />
                    <label for="epli_located_at_ca">CA:</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_located_at_ga" id="epli_located_at_ga"
                        class="form-control required" placeholder="GA:" />
                    <label for="epli_located_at_ga">GA:</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_located_at_tx" id="epli_located_at_tx"
                        class="form-control required" placeholder="TX:" />
                    <label for="epli_located_at_tx">TX:</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_located_at_fl" id="epli_located_at_fl"
                        class="form-control required" placeholder="FL:" />
                    <label for="epli_located_at_fl">FL:</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_located_at_ny" id="epli_located_at_ny"
                        class="form-control required" placeholder="NY:" />
                    <label for="epli_located_at_ny">NY:</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_located_at_nj" id="epli_located_at_nj"
                        class="form-control required" placeholder="NJ:" />
...
<div class="step" id="epli_step_4">
    @if (session('doesEPLIChecked') === 'true')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_salary_range_q1" id="epli_salary_range_q1"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_salary_range_q2" id="epli_salary_range_q2"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_salary_range_q3" id="epli_salary_range_q3"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_emp_terminated_last_12_months_q1"
                        id="epli_emp_terminated_last_12_months_q1" class="form-control required"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_emp_terminated_last_12_months_q2"
                        id="epli_emp_terminated_last_12_months_q2" class="form-control required"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="epli_emp_terminated_last_12_months_q3"
                        id="epli_emp_terminated_last_12_months_q3" class="form-control required"
    ...
    @if (session('doesEPLIChecked') === 'true')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_hr_q1" id="epli_hr_q1" aria-label="epli_hr_q1">
                        <option value selected></option>
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_hr_q2" id="epli_hr_q2" aria-label="epli_hr_q2">
                        <option value selected></option>
                        <option value="0">No</option>
                        <option value="1">Yes</option>
                    </select>
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_hr_q3" id="epli_hr_q3" aria-label="epli_hr_q3">
                        <option value selected></option>
                        <option value="0">No</option>
                        <option value="1">Yes</option>
                    </select>
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_hr_q4" id="epli_hr_q4" aria-label="epli_hr_q4">
                        <option value selected></option>
                        <option value="0">No</option>
                        <option value="1">Yes</option>
                    </select>
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_hr_q5" id="epli_hr_q5" aria-label="epli_hr_q5">
                        <option value selected></option>
                        <option value="0">No</option>
                        <option value="1">Yes</option>
                    </select>
            ...
            <div class="col-md-12">
                ...
                <div class="mb-3 form-floating">
                    <select class="form-select required" name="epli_hr_q6" id="epli_hr_q6" aria-label="">
                        <option value selected></option>
                        <option value="0">No</option>
                        <option value="1">Yes</option>
                    </select>
