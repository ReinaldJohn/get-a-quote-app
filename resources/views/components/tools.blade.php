        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_misc_tools" id="tools_misc_tools" class="form-control"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_sched_equipment" id="tools_sched_equipment" class="form-control"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_equipment_type" id="tools_equipment_type" class="form-control"
            ...
            <div class="col-md-4">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_equipment_year" id="tools_equipment_year" class="form-control"
                        placeholder="YYYY">
            ...
            <div class="col-md-4">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_equipment_make" id="tools_equipment_make" class="form-control"
                        placeholder="Make">
            ...
            <div class="col-md-4">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_equipment_model" id="tools_equipment_model" class="form-control"
                        placeholder="Model">
            ...
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_equipment_vin_or_serial_no" id="tools_equipment_vin_or_serial_no"
                        class="form-control" placeholder="VIN or Serial Number">
            ...
            <div class="col-md-6">
                <div class="mb-3 form-floating">
                    <input type="text" name="tools_equipment_valuation" id="tools_equipment_valuation"
                        class="form-control" placeholder="Valuation">
                    <label for="tools_equipment_valuation">Valuation</label>
                </div>
            </div>
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select" name="tools_equipment_no_of_losses" id="tools_equipment_no_of_losses"
