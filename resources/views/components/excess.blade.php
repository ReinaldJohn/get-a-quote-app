        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select" name="excess_limits" id="excess_limits" aria-label="excess_limits">
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="excess_gl_eff_date" id="excess_gl_eff_date" class="form-control"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <select class="form-select" name="excess_no_of_losses" id="excess_no_of_losses"
...
<div class="step" id="excess_step_2">
    @if (session('doesEXCESSChecked') === 'true')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="excess_insurance_carrier" id="excess_insurance_carrier"
                        class="form-control" placeholder="Insurance Carrier">
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="excess_policy_or_quote_no" id="excess_policy_or_quote_no"
                        class="form-control" placeholder="Policy Number / Quote Number">
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="excess_policy_premium" id="excess_policy_premium" class="form-control"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="excess_effective_date" id="excess_effective_date" class="form-control"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-floating">
                    <input type="text" name="excess_expiration_date" id="excess_expiration_date" class="form-control"
                        placeholder="MM/DD/YYYY">
