            ...
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-12">
                        ...
                        <h2 class="mt-lg-5 mb-3">Terms and Conditions</h2>
                        <p class="mx-2">
                        ...
                        <ul class="mb-4">
                            ...
                            <li>
                                <p class="mb-2"><strong>Feedback</strong> means feedback, innovations or suggestions
                                    sent by You
                            ...
                            <li>
                                <p class="mb-2"><strong>Terms and Conditions</strong> (also referred as
                                    &quot;Terms&quot;) mean these
                                    Terms and Conditions that form the entire agreement between You and the Company
                                    regarding the use of the Service.</p>
                            </li>
                            <li>
                                <p class="mb-2"><strong>Third-party Social Media Service</strong> means any services
                                    or content
                            ...
                            <li>
                                <p class="mb-2"><strong>You</strong> means the individual accessing or using the
                                    Service, or the
                        ...
                        <h3 class="mb-2">Acknowledgment</h3>
                        <p class="mb-4">These are the Terms and Conditions governing the use of this Service and the
                            agreement that
                        ...
                        <p class="mb-4">Your access to and use of the Service is conditioned on Your acceptance of and
                            compliance
                        ...
                        <p class="mb-4">By accessing or using the Service You agree to be bound by these Terms and
                            Conditions. If You
                            disagree with any part of these Terms and Conditions then You may not access the Service.
                        </p>
                        <p class="mb-4">You represent that you are over the age of 18. The Company does not permit
                            those under 18 to
                            use the Service.</p>
                        <p class="mb-4">Your access to and use of the Service is also conditioned on Your acceptance
                            of and
                        ...
                        <p class="mb-4">The Service and its original content (excluding Content provided by You or
                            other users),
                            features and functionality are and will remain the exclusive property of the Company and its
                            licensors.</p>
                        <p class="mb-4">The Service is protected by copyright, trademark, and other laws of both the
                            Country and
                            foreign countries.</p>
                        <p class="mb-4">Our trademarks and trade dress may not be used in connection with any product
                            or service
                            without the prior written consent of the Company.</p>

                        <h3 class="mb-2">Your Feedback to Us</h3>
                        <p class="mb-4">You assign all rights, title and interest in any Feedback You provide the
                            Company. If for any
                        ...
                        <p class="mb-4">Our Service may contain links to third-party web sites or services that are
                            not owned or
                            controlled by the Company.</p>
                        <p class="mb-4">The Company has no control over, and assumes no responsibility for, the
                            content, privacy
                            ...
                            or services.</p>
                        <p class="mb-4">We strongly advise You to read the terms and conditions and privacy policies
                            of any
                            third-party web sites or services that You visit.</p>

                        <h3 class="mb-2">Termination</h3>
                        <p class="mb-4">We may terminate or suspend Your access immediately, without prior notice or
                            liability, for
                        ...
                        <p class="mb-4">Notwithstanding any damages that You might incur, the entire liability of the
                            Company and any
                        ...
                        <p class="mb-4">To the maximum extent permitted by applicable law, in no event shall the
                            Company or its
                        ...
                        <p class="mb-4">Some states do not allow the exclusion of implied warranties or limitation of
                            liability for
                        ...
                        <h3 class="mb-2">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h3>
                        <p class="mb-4">The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot;
                            and with all
                        ...
                        <p class="mb-4">Without limiting the foregoing, neither the Company nor any of the company's
                            provider makes
                        ...
                        <p class="mb-4">Some jurisdictions do not allow the exclusion of certain types of warranties
                            or limitations
                        ...
                        <p class="mb-4">The laws of the Country, excluding its conflicts of law rules, shall govern
                            this Terms and
                        ...
                        <h3 class="mb-2">Disputes Resolution</h3>
                        <p class="mb-4">If You have any concern or dispute about the Service, You agree to first try
                            to resolve the
                            dispute informally by contacting the Company.</p>

                        <h3 class="mb-2">For European Union (EU) Users</h3>
                        <p class="mb-4">If You are a European Union consumer, you will benefit from any mandatory
                            provisions of the
                            law of the country in which You are resident.</p>

                        <h3 class="mb-2">United States Legal Compliance</h3>
                        <p class="mb-4">You represent and warrant that (i) You are not located in a country that is
                            subject to the
                        ...
                        <h4 class="mb-2">Severability and Waiver</h4>
                        <h5 class="mb-2">Severability</h5>
                        <p class="mb-4">If any provision of these Terms is held to be unenforceable or invalid, such
                            provision will
                        ...
                        <p class="mb-4">Except as provided herein, the failure to exercise a right or to require
                            performance of an
                        ...
                        <h3 class="mb-2">Translation Interpretation</h3>
                        <p class="mb-4">These Terms and Conditions may have been translated if We have made them
                            available to You on
                            our Service.
                            You agree that the original English text shall prevail in the case of a dispute.</p>

                        <h3 class="mb-2">Changes to These Terms and Conditions</h3>
                        <p class="mb-2">We reserve the right, at Our sole discretion, to modify or replace these Terms
                            at any time.
                        ...
                        <p class="mb-4">By continuing to access or use Our Service after those revisions become
                            effective, You agree
                        ...
                        <p class="mb-2">If you have any questions about these Terms and Conditions, You can contact
                            us:</p>
                        <ul>
                            <li class="mb-2">
                                <p class="mb-0">By email: <a
                                        href="mailto:termandconditions@pbibins.com">termandconditions@pbibins.com</a>
                                </p>
                            </li>
                            <li class="mb-2">
