...
<head>
    ...
    <title>PBIBINS | Get a Quote Form</title>
	        ...
	        <div class="container-fluid">
	            <div class="row d-flex align-items-center">
	                ...
	                <div class="col-4 text-center">
	                    <a href="index.html"><img src="img/PBIB Logo.png" alt="" class="img-fluid" width="350" height="350"></a>
	                </div>
	                <div class="col-4">
	                    <div id="social">
	                        <ul>
						...
						<div id="middle-wizard">
							<div class="step">
								<div class="question_title">
									<h3>Get Quote Now</h3>
									<p>Select the insurance that you want you to quote and fill up the fields.</p>
								</div>
							...
							<div class="step">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-4">
										<div class="mb-3 form-floating">
											<input type="text" name="personal_website" id="personal_website" class="form-control" placeholder="Website">
									...
									<div class="col-md-4">
										<div class="mb-3 form-floating">
											...
											<label for="contractor_license">Contractor License No.</label>
										</div>
									</div>
								</div>
								<!-- /row -->
							...
							<div class="step" id="gl_step_1">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="gl_cost_proj_5years" id="gl_cost_proj_5years" class="form-control" placeholder="Cost of the Largest Project in the past 5 years?">
							...
							<div class="step" id="gl_step_2">
								...
								<div class="row justify-content-center">
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="gl_annual_gross" id="gl_annual_gross" class="form-control " placeholder="Annual Gross Receipts">
											<label for="gl_annual_gross">Annual Gross Receipts</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="gl_no_field_emp" id="gl_no_field_emp" class="form-control " placeholder="Number of Field Employees">
											<label for="gl_no_field_emp">Number of Field Employees</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="gl_payroll_amt" id="gl_payroll_amt" class="form-control " placeholder="Payroll Amount">
							...
							<div class="step" id="wc_step_1">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12 mt-4">
										<div class="mb-3 form-floating">
											<input type="text" name="wc_gross_receipt" id="wc_gross_receipt" class="form-control " placeholder="Gross Receipt">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="wc_num_of_empl" id="wc_num_of_empl" class="form-control " placeholder="Number of Employees">
							...
							<div class="step" id="wc_step_2">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="wc_title_relationship" id="wc_title_relationship" class="form-control " placeholder="">
							...
							<div class="step" id="bond_step_1">
								...
								<div class="row justify-content-center">
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="bond_owners_name" id="bond_owners_name" class="form-control " placeholder="Owner's Name">
							...
							<div class="step" id="bond_step_2">
								...
								<div class="row justify-content-center">
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="bond_type_bond_requested" id="bond_type_bond_requested" class="form-control " placeholder="Type of Bond Requested">
											<label for="bond_type_bond_requested">Type of Bond Requested</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="bond_amount_of_bond" id="bond_amount_of_bond" class="form-control " placeholder="Amount of Bond">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="bond_license_or_application_no" id="bond_license_or_application_no" class="form-control " placeholder="License Number or Application Number">
							...
							<div class="step" id="excess_step_1">
								...
								<div class="row justify-content-center">
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="excess_limits" id="excess_limits" class="form-control " placeholder="Excess Limits">
							...
							<div class="step" id="excess_step_2">
								...
								<div class="row justify-content-center">
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="excess_insurance_carrier" id="excess_insurance_carrier" class="form-control " placeholder="Insurance Carrier">
											<label for="excess_insurance_carrier">Insurance Carrier</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="excess_policy_or_quote_no" id="excess_policy_or_quote_no" class="form-control " placeholder="Policy Number / Quote Number">
											<label for="excess_policy_or_quote_no">Policy Number / Quote Number</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="excess_policy_premium" id="excess_policy_premium" class="form-control " placeholder="Policy Premium">
							...
							<div class="step" id="tools_step_1">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="tools_equipment_type" id="tools_equipment_type" class="form-control " placeholder="Equipment Type">
											<label for="tools_equipment_type">Equipment Type</label>
										</div>
									</div>
									<div class="col-md-4">
										<div class="mb-3 form-floating">
											<input type="text" name="tools_equipment_year" id="tools_equipment_year" class="form-control " placeholder="YYYY">
											<label for="tools_equipment_year">Year</label>
										</div>
									</div>
									<div class="col-md-4">
										<div class="mb-3 form-floating">
											<input type="text" name="tools_equipment_make" id="tools_equipment_make" class="form-control " placeholder="Make">
											<label for="tools_equipment_make">Make</label>
										</div>
									</div>
									<div class="col-md-4">
										<div class="mb-3 form-floating">
											<input type="text" name="tools_equipment_model" id="tools_equipment_model" class="form-control " placeholder="Model">
											<label for="tools_equipment_model">Model</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-3 form-floating">
											<input type="text" name="tools_equipment_vin_or_serial_no" id="tools_equipment_vin_or_serial_no" class="form-control " placeholder="VIN or Serial Number">
											<label for="tools_equipment_vin_or_serial_no">VIN or Serial Number</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-3 form-floating">
											<input type="text" name="tools_equipment_valuation" id="tools_equipment_valuation" class="form-control " placeholder="Valuation">
							...
							<div class="step" id="br_step_1">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="br_value_of_existing_structure" id="br_value_of_existing_structure" class="form-control " placeholder="Value of Existing Structure">
											<label for="br_value_of_existing_structure">Value of Existing Structure</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="br_value_of_work_performed" id="br_value_of_work_performed" class="form-control " placeholder="Value of Work Being Performed">
											<label for="br_value_of_work_performed">Value of Work Being Performed</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="br_period_duration_project" id="br_period_duration_project" class="form-control " placeholder="Period of Insurance / Duration of the Project">
							...
							<div class="step" id="pollution_step_1">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12">
										<div class="mb-3 form-floating">
											<input type="text" name="pollution_cost_proj_5years" id="pollution_cost_proj_5years" class="form-control" placeholder="">
							...
							<div class="step">
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-12">
										<div class="form-floating mb-3">
											<input type="text" name="ayc_date_business_started" id="ayc_date_business_started" class="form-control " placeholder="MM/DD/YYYY">
									...
									<div class="col-md-12">
										<div class="form-floating mb-3">
											<input type="text" name="ayc_owners_first_name" id="ayc_owners_first_name" class="form-control " placeholder="">
											<label for="ayc_owners_first_name">Owner’s First Name</label>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-floating mb-3">
											<input type="text" name="ayc_owners_last_name" id="ayc_owners_last_name" class="form-control " placeholder="">
